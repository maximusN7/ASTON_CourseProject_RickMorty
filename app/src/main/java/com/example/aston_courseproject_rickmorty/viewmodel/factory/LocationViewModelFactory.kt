...
class LocationViewModelFactory(context: Context, appContext: Context, owner: FragmentActivity, private val filterList: MutableList<Filter>) : ViewModelProvider.Factory {
    ...
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        return LocationViewModel(mainViewModel, database, filterList) as T
    }
}